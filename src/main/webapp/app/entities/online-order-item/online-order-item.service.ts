...
export class OnlineOrderItemService {
    ...
    findByOnlineOrder(id: number): Observable<EntityArrayResponseType> {
        return this.http.get<IOnlineOrderItem[]>(`${this.resourceUrl}/delivery-order/${id}`, { observe: 'response' });
    }
